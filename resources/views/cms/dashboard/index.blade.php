...
<div class="alert alert-primary d-flex align-items-center justify-content-between mb-4 p-4 br-15" role="alert">
    <div class="d-flex align-items-center gap-3">
        <div class="avatar-md bg-primary bg-opacity-25 rounded-circle d-flex align-items-center justify-content-center">
            <iconify-icon icon="solar:home-bold" class="fs-32 text-primary"></iconify-icon>
        </div>
        <div>
         ...
         <div class="card">
              <div class="card-body">
                   <div class="row">
                        ...
                        <div class="col-6 text-end">
                             <p class="text-muted mb-0 text-truncate">Incoming BTA Today</p>
                             <h3 class="text-dark mt-1 mb-0">{{ number_format($incoming_bta) }}</h3>
                        </div>
                   </div>
              </div>
              <div class="card-footer border-0 py-2 bg-light bg-opacity-50">
                   <div class="d-flex align-items-center justify-content-between">
                        <div>
                             <span class="text-muted ms-1 fs-12">Today</span>
                        </div>
                        <a href="{{ route('base-to-agent-incoming.index') }}" class="text-reset fw-semibold fs-12">View More</a>
                   </div>
              </div>
         </div>
    </div>
         ...
         <div class="card">
              <div class="card-body">
                   <div class="row">
                        ...
                        <div class="col-6 text-end">
                             <p class="text-muted mb-0 text-truncate">Incoming CTA Today</p>
                             <h3 class="text-dark mt-1 mb-0">{{ number_format($incoming_cta) }}</h3>
                        </div>
                   </div>
              </div>
              <div class="card-footer border-0 py-2 bg-light bg-opacity-50">
                   <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('customer-to-agent-incoming.index') }}" class="text-reset fw-semibold fs-12">View More</a>
                   </div>
              </div>
         </div>
    </div>
         ...
         <div class="card">
              <div class="card-body">
                   <div class="row">
                        ...
                        <div class="col-6 text-end">
                             <p class="text-muted mb-0 text-truncate">Outgoing ATB Today</p>
                             <h3 class="text-dark mt-1 mb-0">{{ number_format($outgoing_atb) }}</h3>
                        </div>
                   </div>
              </div>
              <div class="card-footer border-0 py-2 bg-light bg-opacity-50">
                   <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('agent-to-base-outgoing.index') }}" class="text-reset fw-semibold fs-12">View More</a>
                   </div>
              </div>
         </div>
    </div>
         ...
         <div class="card">
              <div class="card-body">
                   <div class="row">
                        ...
                        <div class="col-6 text-end">
                             <p class="text-muted mb-0 text-truncate">Outgoing ATC Today</p>
                             <h3 class="text-dark mt-1 mb-0">{{ number_format($outgoing_atc) }}</h3>
                        </div>
                   </div>
              </div>
              <div class="card-footer border-0 py-2 bg-light bg-opacity-50">
                   <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('agent-to-customer-outgoing.index') }}" class="text-reset fw-semibold fs-12">View More</a>
                   </div>
              </div>
         </div>
    </div> --}}
