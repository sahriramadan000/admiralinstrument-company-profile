...
<div class="nxl-content">
    <div class="main-content">
        <form action="{{ route('cms.users.update', $user->id) }}" method="post" enctype="multipart/form-data" class="row">
            @csrf
            @method("PUT")
            <div class="col-12">
                ...
                <div class="card border-top-0" style="border-radius: 15px;">
                    <div class="card-body personal-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label fw-semibold">Name</label>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label fw-semibold">Username</label>
