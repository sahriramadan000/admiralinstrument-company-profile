<div class="container-fluid">
    <div class="navbar-header">
         ...
         <div class="">
            <h4 class="mb-1 text-dark fw-bold text-uppercase">CMS ADMIRAL INSTRUMENT</h4>
         </div>
              ...
              <div class="dropdown topbar-item">
                   <a type="button" class="topbar-button" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                             <img class="rounded-circle" src="{{ asset('assets/img/profile_picture/' . (Auth::user()->avatar ? Auth::user()->avatar : 'default.png' )) }}" alt="avatar-3" style="width: 32px; height: 32px; object-fit: cover; border-radius: 50%;">
                        </span>
                   </a>
                   <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('cms.settings') }}">
